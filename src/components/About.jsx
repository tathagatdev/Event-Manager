    ...
    return (
        <>
            ...
            <div className='container col-md-6 center'>
                <h1 className="text-center fw-bold">The simple way to <br /> Create Events</h1>
                <h4 className="text-center para">All your events, synced on all your devices. <span className="fw-bold" to="/"><span style={{ color: '#6f42c1' }}>Event</span>Maker</span> now for iOS, Android, Mac, Windows, Linux, or in your browser.</h4>
                ...
                <div className="row text-center row-cols-1 row-cols-md-3 g-4">
                    <div className="col">
                        <div className="card bg-light h-100">
                            ...
                            <div className="card-body">
                                ...
                                <p className="card-text">Events stay updated across all your devices, automatically and in real time. There’s no “sync” button: It just works.</p>
                            </div>
                        </div>
                    </div>
                    <div className="col">
                        <div className="card bg-light h-100">
                            ...
                            <div className="card-body">
                                ...
                                <p className="card-text">Add tags to find Events quickly.</p>
                            </div>
                        </div>
                    </div>
                    <div className="col">
                    ...
                    <div className="col">
                        <div className="card bg-light h-100">
                            ...
                            <div className="card-body">
                                <h5 className="card-title fw-bold">Try Event Maker</h5>
            ...
            <div className="credits mt-3">
                Designed by <span>Tathagat</span>
            </div>
        </>
    )
}
